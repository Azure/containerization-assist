...
RG="${FLAG_RG:-${CCP_RESOURCE_GROUP:-}}"
LOCATION="${FLAG_LOC:-${CCP_LOCATION:-}}"
RES="${FLAG_RES:-${CCP_OPENAI_RESOURCE_NAME:-}}"
DEPLOY="${FLAG_DEP:-${CCP_DEPLOYMENT_NAME:-}}"
MODEL_ID="${FLAG_MOD:-${CCP_MODEL_ID:-$DEFAULT_MODEL}}"
MODEL_VERSION="${FLAG_VER:-${CCP_MODEL_VERSION:-$DEFAULT_MODEL_VERSION}}"
TARGET_REPO="${FLAG_TR:-${CCP_TARGET_REPO:-}}"

# 5) validate required CCP_* settings
MISSING=()
