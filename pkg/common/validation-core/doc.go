...
//	)
//
//	func validateDockerfile(content string) *core.Result {
...
//
//	import "github.com/Azure/container-kit/pkg/common/validation-core/chains"
//
...
//	}
//
//	func (m *MyValidator) Validate(ctx context.Context, data interface{}, options *core.ValidationOptions) *core.Result {
//		// Custom validation logic here
//		result := m.BaseValidatorImpl.Validate(ctx, data, options)
//
//		// Add your validation logic
//		if someCondition {
//			result.AddError(core.NewError("MY_ERROR", "Something is wrong", core.ErrTypeValidation, core.SeverityMedium))
//		}
//
//		return result
//	}
