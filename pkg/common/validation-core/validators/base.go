...
func (b *BaseValidatorImpl) Validate(ctx context.Context, data interface{}, options *core.ValidationOptions) *core.NonGenericResult {
	startTime := time.Now()

	// Use factory function from unified validation framework
	result := core.NewNonGenericResult(b.Name, b.Version)
...
func (a *AlwaysFailValidator) Validate(ctx context.Context, data interface{}, options *core.ValidationOptions) *core.NonGenericResult {
