...
func (d *DeploymentValidator) Validate(ctx context.Context, data interface{}, options *core.ValidationOptions) *core.NonGenericResult {
	startTime := time.Now()
...
func (d *DeploymentValidator) validateDeploymentData(data map[string]interface{}, result *core.NonGenericResult, options *core.ValidationOptions) {
...
func (d *DeploymentValidator) validateDeploymentStruct(data DeploymentData, result *core.NonGenericResult, options *core.ValidationOptions) {
	// Validate image reference
...
func (d *DeploymentValidator) validateDeploymentArgs(args DeploymentArgs, result *core.NonGenericResult, options *core.ValidationOptions) {
	// Required fields
	if args.ImageRef == "" {
		result.AddFieldError("image_ref", "Image reference is required")
	} else {
...
func (d *DeploymentValidator) validateDeploymentResult(result DeploymentResult, validationResult *core.NonGenericResult, options *core.ValidationOptions) {
...
func (d *DeploymentValidator) validateImageRef(imageRef, field string, result *core.NonGenericResult) {
	if imageRef == "" {
...
func (d *DeploymentValidator) validateNamespace(namespace, field string, result *core.NonGenericResult) {
	if namespace == "" {
...
func (d *DeploymentValidator) validateAppName(appName, field string, result *core.NonGenericResult) {
	if appName == "" {
...
func (d *DeploymentValidator) validateTimeout(timeout interface{}, field string, result *core.NonGenericResult) {
...
func (d *DeploymentValidator) validateTimeoutDuration(timeout time.Duration, field string, result *core.NonGenericResult) {
	if timeout <= 0 {
		result.AddFieldError(field, "Timeout must be positive")
...
func (d *DeploymentValidator) validateManifestPath(path, field string, result *core.NonGenericResult) {
	if path == "" {
		return
	}
...
func ValidateDeploymentConfig(config map[string]interface{}) *core.NonGenericResult {
...
// ValidateDeploymentArgs validates deployment arguments
func ValidateDeploymentArgs(args DeploymentArgs) *core.NonGenericResult {
	validator := NewDeploymentValidator()
	ctx := context.Background()
	options := core.NewValidationOptions()
...
// ValidateDeploymentResult validates deployment result
func ValidateDeploymentResult(result DeploymentResult) *core.NonGenericResult {
	validator := NewDeploymentValidator()
	ctx := context.Background()
	options := core.NewValidationOptions()
