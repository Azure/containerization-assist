...
import (
	...
	progresstest "github.com/Azure/containerization-assist/pkg/infrastructure/core/testutil/progress"
...
func TestWorkflowOrchestrator_ProgressTracking(t *testing.T) {
	...
	if len(updates) > 1 {
		...
		for i := 1; i < len(updates); i++ {
			assert.GreaterOrEqual(t, updates[i].Step, updates[i-1].Step, "Steps should be monotonically increasing")
		}
	}
