...
func (cm *CacheManager) Get(_ context.Context, key string) (*CacheOperation, error) {
	startTime := time.Now()
...
func (cm *CacheManager) Set(_ context.Context, key string, value interface{}, ttl time.Duration) error {
	if ttl == 0 {
...
func (cm *CacheManager) Delete(_ context.Context, key string) error {
	cm.cacheMutex.Lock()
	defer cm.cacheMutex.Unlock()
...
func (cm *CacheManager) Clear(_ context.Context) error {
	cm.cacheMutex.Lock()
	defer cm.cacheMutex.Unlock()
...
func (cm *CacheManager) Exists(_ context.Context, key string) (bool, error) {
	cm.cacheMutex.RLock()
	entry, exists := cm.cache[key]
	cm.cacheMutex.RUnlock()
...
func (cm *CacheManager) Keys(_ context.Context) ([]string, error) {
	cm.cacheMutex.RLock()
...
func (cm *CacheManager) Size(_ context.Context) (int, error) {
	cm.cacheMutex.RLock()
	defer cm.cacheMutex.RUnlock()
...
func (cm *CacheManager) GetSize(_ context.Context) (int64, error) {
	cm.cacheMutex.RLock()
	defer cm.cacheMutex.RUnlock()
...
func (cm *CacheManager) Shutdown(_ context.Context) error {
