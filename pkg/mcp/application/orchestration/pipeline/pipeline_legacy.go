...
// Deprecated: Use NewPipelineService instead for new code
...
func (m *Manager) Stop() error {
	...
	if err := m.workerManager.StopAll(); err != nil {
		m.logger.Error("Error stopping worker manager", "error", err)
	}
...
// Status represents the overall status of the pipeline
type Status struct {
