...
func TestOperations_ScanSecurityTyped(t *testing.T) {
	tests := []struct {
		name        string
		sessionID   string
		params      domain.ConsolidatedScanParams
		expectError bool
		errorMsg    string
	}{
		{
...
func TestOperations_ScanSecretsTyped(t *testing.T) {
	tests := []struct {
		name        string
		sessionID   string
		params      domain.ScanSecretsParams
		expectError bool
		errorMsg    string
	}{
		{
...
func TestAnalyzeParams_Validation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.IsType(t, domain.AnalyzeParams{}, tt.params)
...
func TestConsolidatedScanParams_Validation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Test parameter structure
			assert.IsType(t, domain.ConsolidatedScanParams{}, tt.params)
