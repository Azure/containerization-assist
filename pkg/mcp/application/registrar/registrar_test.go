...
func TestNewMCPRegistrar(t *testing.T) {
	...
	assert.NotNil(t, registrar.tools)
...
func TestRegistrar_ComponentInitialization(t *testing.T) {
	...
	assert.NotNil(t, registrar.tools, "Tools registry should be initialized")
	assert.NotNil(t, registrar.resources, "Resources registry should be initialized")
}
...
func TestNewToolRegistrar(t *testing.T) {
	...
	toolRegistrar := NewToolRegistrar(logger, mockOrchestrator)
...
func TestNewResourceRegistrar(t *testing.T) {
	...
	resourceRegistrar := NewResourceRegistrar(logger, mockResourceStore)
