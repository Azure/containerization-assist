...
type AIAnalyzer interface {
	...
	AnalyzeWithContext(ctx context.Context, prompt string, context map[string]interface{}) (string, error)
...
// TypedPipelineOperations provides typed operations for pipeline management
...
// ToolOrchestrator manages tool execution and registration
