...
func TestAtomicDetectDatabasesTool(t *testing.T) {
	...
	testCases := []struct {
		...
		expectedDBs   []database_detectors.DatabaseType
...
`,
			...
			expectedDBs:   []database_detectors.DatabaseType{database_detectors.PostgreSQL},
			minConfidence: 0.3,
		},
		{
...
`,
  ...
  "dependencies": {
    "mysql2": "^3.0.0"
			...
			expectedDBs:   []database_detectors.DatabaseType{database_detectors.MySQL},
			minConfidence: 0.2,
		},
		{
...
`,
			...
			expectedDBs:   []database_detectors.DatabaseType{database_detectors.MongoDB},
			minConfidence: 0.1,
		},
		{
...
`,
			...
			expectedDBs:   []database_detectors.DatabaseType{database_detectors.Redis},
			minConfidence: 0.4,
		},
		{
...
`,
  ...
  "dependencies": {
    ...
    "redis": "^4.0.0"
			...
			expectedDBs:   []database_detectors.DatabaseType{database_detectors.PostgreSQL, database_detectors.Redis},
			minConfidence: 0.2,
		},
	}
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			detectedTypes := make(map[database_detectors.DatabaseType]bool)
...
func TestAtomicDetectDatabasesToolValidation(t *testing.T) {
	...
	invalidParams := database_detectors.DatabaseDetectionParams{
