...
type ErrorHandler func(ctx context.Context, err error, context *ConsolidatedErrorContext) (*RoutingDecision, error)

// ConsolidatedErrorContext provides context about the error
...
func (er *ErrorRouter) RouteError(ctx context.Context, errorCtx *ConsolidatedErrorContext) (*RoutingDecision, error) {
	er.logger.Info().
	...
	if err != nil {
		return nil, errors.NewError().Message("failed to apply routing rule").Cause(err).WithLocation(
...
func (er *ErrorRouter) findMatchingRules(errorCtx *ConsolidatedErrorContext) []FailureRoutingRule {
...
func (er *ErrorRouter) matchesRule(errorCtx *ConsolidatedErrorContext, rule FailureRoutingRule) bool {
	// Check source tool
...
func (er *ErrorRouter) evaluateConditions(errorCtx *ConsolidatedErrorContext, conditions map[string]interface{}) bool {
...
func (er *ErrorRouter) applyRoutingRule(ctx context.Context, errorCtx *ConsolidatedErrorContext, rule FailureRoutingRule) (*RoutingDecision, error) {
	...
	if handler, exists := er.errorHandlers[handlerKey]; exists {
		customDecision, err := handler(ctx, errors.NewError().Messagef("%s", errorCtx.ErrorMessage).WithLocation().Build(), errorCtx)
...
func (er *ErrorRouter) handleDefaultError(ctx context.Context, errorCtx *ConsolidatedErrorContext) (*RoutingDecision, error) {
...
func (er *ErrorRouter) saveRoutingDecision(ctx context.Context, errorCtx *ConsolidatedErrorContext, decision *RoutingDecision) {
...
func (er *ErrorRouter) registerDefaultHandlers() {
	...
	er.RegisterHandler("build_image", "analyze_repository", func(ctx context.Context, err error, errorCtx *ConsolidatedErrorContext) (*RoutingDecision, error) {
	...
	er.RegisterHandler("scan_security", "build_image", func(ctx context.Context, err error, errorCtx *ConsolidatedErrorContext) (*RoutingDecision, error) {
		...
		return nil, errors.NewError().Messagef("not a base image vulnerability").WithLocation(

		// Deploy failure -> Generate manifests handler
		).Build()
	})

	er.RegisterHandler("deploy_kubernetes", "generate_manifests", func(ctx context.Context, err error, errorCtx *ConsolidatedErrorContext) (*RoutingDecision, error) {
		...
		return nil, errors.NewError().Messagef("not a validation error").WithLocation(
...
func (er *ErrorRouter) GetRoutingHistory(ctx context.Context, sessionID string) ([]map[string]interface{}, error) {
	...
	return nil, errors.NewError().Messagef("invalid routing history format").WithLocation(
