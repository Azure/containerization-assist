...
type Generator interface {
	...
	// ValidateManifests validates generated manifests using unified validation
	ValidateManifests(ctx context.Context, manifestPath string) (*core.DeployResult, error)
}
...
func NewManifestGenerator(logger *slog.Logger) *ManifestGenerator {
	return &ManifestGenerator{
		logger:    logger.With("component", "manifest_generator"),
...
func (g *ManifestGenerator) GenerateManifests(ctx context.Context, opts GenerationOptions) (*GenerationResult, error) {
	...
	g.logger.Info("Starting manifest generation",
		"namespace", opts.Namespace,
		"image", opts.ImageRef.String(),
		"include_ingress", opts.IncludeIngress)
	...
	g.logger.Info("Manifest generation completed",
...
// ValidateManifests validates the generated manifests using unified validation
func (g *ManifestGenerator) ValidateManifests(ctx context.Context, manifestPath string) (*core.DeployResult, error) {
