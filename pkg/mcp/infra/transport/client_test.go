...
func TestClient_Call_Client_Closed(t *testing.T) {
	...
	require.Error(t, err)
	assert.Nil(t, result)
	assert.Contains(t, strings.ToLower(err.Error()), "client closed")
}
...
func TestClient_Call_Invalid_Params(t *testing.T) {
	...
	require.Error(t, err)
	assert.Nil(t, result)
	assert.Contains(t, strings.ToLower(err.Error()), "failed to marshal request")
}
...
func TestClient_Call_Write_Error(t *testing.T) {
	...
	require.Error(t, err)
	assert.Nil(t, result)
	assert.Contains(t, strings.ToLower(err.Error()), "failed to write request")
}
