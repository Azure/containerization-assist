...
func createBuildProfile(analysis *AnalyzeResult, dockerfile *DockerfileResult) ml.BuildProfile {
	profile := ml.BuildProfile{
		...
		Dependencies: 0,  // TODO: Extract from analysis.Analysis map
		BuildSystem:  "", // TODO: Extract from analysis.Analysis map
...
func (a *analyzeResultAdapter) GetDependencies() []string { return []string{} } // TODO: Extract from Analysis map
func (a *analyzeResultAdapter) GetBuildCommand() string   { return "" }         // TODO: Extract from Analysis map
func (a *analyzeResultAdapter) GetStartCommand() string   { return "" }         // TODO: Extract from Analysis map
