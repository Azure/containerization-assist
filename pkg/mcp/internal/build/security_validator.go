...
func ValidateDockerfileSecurity(content string, logger zerolog.Logger, trustedRegistries []string) (*ValidationResult, error) {
...
func ProcessDockerfileVulnerabilities(scanResult *VulnerabilityScanResult) *ValidationResult {
