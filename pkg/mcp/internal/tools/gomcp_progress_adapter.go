...
func NewGoMCPProgressAdapter(serverCtx *server.Context, stages []interfaces.ProgressStage) *GoMCPProgressAdapter {
...
func (a *GoMCPProgressAdapter) GetCurrentStage() (int, interfaces.ProgressStage) {
	if a.current >= 0 && a.current < len(a.stages) {
		return a.current, a.stages[a.current]
	}
	return 0, interfaces.ProgressStage{}
}
...
func ExecuteToolWithGoMCPProgress[TArgs any, TResult any](
	serverCtx *server.Context,
	stages []interfaces.ProgressStage,
	executeFn func(ctx context.Context, args TArgs, reporter interfaces.ProgressReporter) (TResult, error),
