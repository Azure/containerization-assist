...
func (v *ManifestValidator) ValidateManifest(manifest GeneratedManifest) error {
	v.logger.Debug().
...
func (v *ManifestValidator) ValidateManifests(manifests []GeneratedManifest) []ValidationResult {
...
func (v *ManifestValidator) checkBestPractices(manifest GeneratedManifest) []string {
	var warnings []string
...
func (v *ManifestValidator) validateCrossReferences(manifests []GeneratedManifest, results []ValidationResult) {
