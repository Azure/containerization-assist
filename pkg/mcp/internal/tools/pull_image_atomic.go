...
func (t *AtomicPullImageTool) ExecutePullImage(ctx context.Context, args AtomicPullImageArgs) (*AtomicPullImageResult, error) {
	...
	result := &AtomicPullImageResult{
		...
		BaseAIContextResult: NewBaseAIContextResult("pull", false, 0), // Will be updated later
...
func (t *AtomicPullImageTool) ExecuteWithContext(serverCtx *server.Context, args AtomicPullImageArgs) (*AtomicPullImageResult, error) {
	...
	result.BaseAIContextResult = NewBaseAIContextResult("pull", result.Success, result.TotalDuration)
...
func (t *AtomicPullImageTool) executeWithProgress(ctx context.Context, args AtomicPullImageArgs, result *AtomicPullImageResult, startTime time.Time, reporter interfaces.ProgressReporter) error {
	...
	if args.DryRun {
		...
		result.BaseAIContextResult = NewBaseAIContextResult("pull", true, result.TotalDuration)
