...
// TestAnalyzerConfig_LoadFromEnv - DISABLED due to internal package dependency
// This test would need to be moved to the config package or refactored to use public interfaces
