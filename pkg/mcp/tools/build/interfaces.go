...
// BuildConfig is defined in common.go
// BuildSession is defined in common.go
// SecurityScanResult is defined in docker_build_consolidated.go
...
// DockerfileAnalysis is defined in enhanced_build_analyzer.go
