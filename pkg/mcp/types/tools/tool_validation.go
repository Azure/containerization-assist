...
func NewRichValidationError(toolName, field, message string) *rich.RichError {
...
func NewRichValidationErrorWithCode(toolName, field, message, code string) *rich.RichError {
