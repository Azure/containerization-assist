...
func (s *SecurityScanValidator) Validate(ctx context.Context, data interface{}, options *core.ValidationOptions) *core.ValidationResult {
	startTime := time.Now()
...
func (s *SecurityScanValidator) validateScanData(data map[string]interface{}, result *core.ValidationResult, options *core.ValidationOptions) {
	// Validate session ID
...
func (s *SecurityScanValidator) validateSecretScanArgs(args SecretScanArgs, result *core.ValidationResult, options *core.ValidationOptions) {
	// Validate session ID
	if args.SessionID == "" {
		result.AddFieldError("session_id", "Session ID is required")
	}
...
func (s *SecurityScanValidator) validateSecretScanResult(result SecretScanResult, validationResult *core.ValidationResult, options *core.ValidationOptions) {
...
func (s *SecurityScanValidator) validateImageScanArgs(args ImageScanArgs, result *core.ValidationResult, options *core.ValidationOptions) {
	// Validate session ID
	if args.SessionID == "" {
		result.AddFieldError("session_id", "Session ID is required")
	}
...
func (s *SecurityScanValidator) validateImageScanResult(result ImageScanResult, validationResult *core.ValidationResult, options *core.ValidationOptions) {
	// Validate security score
	if result.SecurityScore < 0 || result.SecurityScore > 100 {
		validationResult.AddFieldError("security_score", "Security score must be between 0 and 100")
	}
...
func (s *SecurityScanValidator) validateVulnerabilityData(data VulnerabilityData, result *core.ValidationResult, options *core.ValidationOptions) {
...
func (s *SecurityScanValidator) validateScanPath(path, field string, result *core.ValidationResult) {
	if path == "" {
...
func (s *SecurityScanValidator) validateImageName(imageName, field string, result *core.ValidationResult) {
	if imageName == "" {
...
func (s *SecurityScanValidator) validateDetectedSecret(secret DetectedSecret, field string, result *core.ValidationResult) {
	if secret.Type == "" {
...
func (s *SecurityScanValidator) validateVulnerability(vuln Vulnerability, field string, result *core.ValidationResult) {
	if vuln.ID == "" {
...
func (s *SecurityScanValidator) validateCriticalFinding(finding CriticalFinding, field string, result *core.ValidationResult) {
	if finding.Type == "" {
...
// ValidateSecretScanArgs validates secret scanning arguments
func ValidateSecretScanArgs(args interface{}) *core.ValidationResult {
...
// ValidateImageScanArgs validates image scanning arguments
func ValidateImageScanArgs(args interface{}) *core.ValidationResult {
	validator := NewSecurityScanValidator()
	ctx := context.Background()
	options := core.NewValidationOptions()
...
func ValidateSecurityScanResult(result interface{}) *core.ValidationResult {
	validator := NewSecurityScanValidator()
	ctx := context.Background()
	options := core.NewValidationOptions()
