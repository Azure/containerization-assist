...
var toolConfigs = []ToolConfig{
	...
	},
	{
		...
		Description:         "Verify an AI-generated optimized Dockerfile based on repository analysis",
		Category:            CategoryWorkflow,
		RequiredParams:      []string{"session_id"},
		NeedsStepProvider:   true,
		NeedsSessionManager: true,
	...
	},
	{
		...
		NextTool:            "verify_k8s_manifests",
		ChainReason:         "Image pushed successfully. Ready to verify Kubernetes manifests",
	},
	{
		...
		ChainReason:         "Kubernetes manifests verified. Ready to prepare cluster",
	},
	{
