...
var toolConfigs = []ToolConfig{
	...
	},
	{
		...
		Description:         "Resolve recommended base images from catalog based on repository analysis",
		Category:            CategoryWorkflow,
		RequiredParams:      []string{"session_id"},
		NeedsStepProvider:   true,
		NeedsSessionManager: true,
		NeedsLogger:         true,
		StepGetterName:      "GetResolveBaseImagesStep",
		NextTool:            "generate_dockerfile",
		ChainReason:         "Base images resolved successfully. Ready to generate Dockerfile with recommendations",
	},
	{
	...
	},
	{
		...
		Description:    "Generate Azure Container Apps deployment manifests (Bicep or ARM templates) - Alternative to Kubernetes deployment",
		Category:       CategoryWorkflow,
		RequiredParams: []string{"session_id"},
		OptionalParams: map[string]interface{}{
		...
		NeedsSessionManager: true,
		NeedsLogger:         true,
		StepGetterName:      "GetAzureContainerAppsStep",
		NextTool:            "validate_azure_manifests",
		ChainReason:         "Azure Container Apps manifests generated. Use validate_azure_manifests to validate them",
	},
	{
		...
		NeedsSessionManager: true,
		NeedsLogger:         true,
		StepGetterName:      "GetValidateAzureStep",
		NextTool:            "", // End of Azure-specific workflow
		ChainReason:         "",
	},
	{
