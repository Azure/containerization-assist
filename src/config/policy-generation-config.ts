 ...
 */
export const dockerfileGenerationConfigSchema = z
  .object({
    /**
 ...
 */
export const resourceDefaultsSchema = z
  .object({
    /**
 ...
 */
export const orgStandardsSchema = z
  .object({
    /**
 ...
 */
export const k8sGenerationConfigSchema = z
  .object({
    /**
 ...
 */
export const dockerfileTemplateSnippetSchema = z
  .object({
    /**
 ...
 */
export const k8sTemplateComponentSchema = z
  .object({
    /**
     * Unique identifier for this template
     */
 ...
 */
export const templateAdditionsSchema = z
  .object({
    /**
 ...
 */
export const hpaConfigSchema = z
  .object({
    /**
 ...
 */
export const dynamicDefaultsSchema = z
  .object({
    /**
