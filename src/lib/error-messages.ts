...
export const ERROR_MESSAGES = {
  ...
  POLICY_BLOCKED: (rules: string[]) =>
    ...
    `Tip: Review policy configuration or adjust enforcement level. See docs/policy-guide.md`,
  ...
  POLICY_LOAD_FAILED: (error: string) =>
    ...
    `Tip: Verify policy file exists and is valid YAML. See docs/policy-guide.md for format.`,
