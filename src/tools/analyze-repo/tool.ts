...
export default tool({
  name: 'analyze-repo',
  description:
    'Analyze repository structure and detect technologies by parsing config files to prepare for containerization and generating container artifacts like dockerfiles and kubnernetes manifests',
  category: 'analysis',
  version: '4.0.0',
