/**
 * Schema definition for resolve-base-images tool
 */
...
export const resolveBaseImagesPlanSchema = resolveBaseImagesSchema;
export type ResolveBaseImagesPlanParams = ResolveBaseImagesParams;
