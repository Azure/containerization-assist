...
describe('Sampling Functions', () => {
  ...
  describe('sampleWithCache', () => {
    ...
    it('should skip cache when disabled', async () => {
      ...
      const result1 = await sampleWithCache('test-key-2', generate, score, { useCache: false });
      const result2 = await sampleWithCache('test-key-2', generate, score, { useCache: false });
